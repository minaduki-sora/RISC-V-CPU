...
HD_PWD='D:/learn/vivado/cod/lab5_5_Stage_CPU/lab5_5_Stage_CPU.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_PL.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CPU_PL.tcl -notrace
