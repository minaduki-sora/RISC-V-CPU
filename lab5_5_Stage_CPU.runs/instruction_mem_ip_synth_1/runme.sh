...
HD_PWD='D:/learn/vivado/cod/lab5_5_Stage_CPU/lab5_5_Stage_CPU.runs/instruction_mem_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log instruction_mem_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source instruction_mem_ip.tcl
