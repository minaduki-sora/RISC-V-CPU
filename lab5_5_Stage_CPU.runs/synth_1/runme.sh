...
HD_PWD='D:/learn/vivado/cod/lab5_5_Stage_CPU/lab5_5_Stage_CPU.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_PL.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_PL.tcl
